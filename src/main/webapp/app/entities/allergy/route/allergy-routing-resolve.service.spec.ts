...
describe('Allergy routing resolve service', () => {
  ...
  let routingResolveService: AllergyRoutingResolveService;
  let service: AllergyService;
  let resultAllergy: IAllergy | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(AllergyRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new IAllergy if id is not provided', () => {
      // GIVEN
      ...
      expect(resultAllergy).toEqual(new Allergy());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Allergy })));
      mockActivatedRouteSnapshot.params = { id: 123 };
