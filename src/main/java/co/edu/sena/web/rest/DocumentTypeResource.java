    ...
    public ResponseEntity<DocumentType> partialUpdateDocumentType(
        ...
        Optional<DocumentType> result = documentTypeRepository
            ...
            .map(existingDocumentType -> {
                if (documentType.getDocumentName() != null) {
                    existingDocumentType.setDocumentName(documentType.getDocumentName());
                }
                if (documentType.getInitials() != null) {
                    existingDocumentType.setInitials(documentType.getInitials());
                }
                if (documentType.getStateDocumentType() != null) {
                    existingDocumentType.setStateDocumentType(documentType.getStateDocumentType());
                }
