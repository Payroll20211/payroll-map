    ...
    public ResponseEntity<CostCenter> partialUpdateCostCenter(
        ...
        Optional<CostCenter> result = costCenterRepository
            ...
            .map(existingCostCenter -> {
                if (costCenter.getCostCenterCode() != null) {
                    existingCostCenter.setCostCenterCode(costCenter.getCostCenterCode());
                }
                if (costCenter.getCostCenterName() != null) {
                    existingCostCenter.setCostCenterName(costCenter.getCostCenterName());
                }
                if (costCenter.getCostCenterType() != null) {
                    existingCostCenter.setCostCenterType(costCenter.getCostCenterType());
                }
